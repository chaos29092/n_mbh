...
return array(
    ...
    'op_1' => 'I am delighted to report that during the first half of 2014 the establishment plan for Imperial Yachting LLC in Dubai has been successful in securing a number of regional dealership and agency agreements with some of the world’s premier boat and yacht builders with whom we are receiving the highest level of support and co-operation.',
    'op_2' => 'In addition, encouraging discussions continue with Super Yacht Builders to obtain agreement to market their vessels in the MENA area.',
    'op_3' => 'The Partners of Imperial Yachting LLC have combined 40 years global experience in business with many in the GCC the majority in the marine Industry in the United Kingdom, Spain and Middle East.',
    'op_4' => 'As Boat and Yacht owners past and present we know first hand what is involved in owning and maintaining a yacht . We understand that every client is unique that is why Imperial Yachting provide every client a bespoke service.',
...
//factory's photo
    'fv_1' => 'overall view',
    'fv_2' => 'factory corner',
    'fv_3' => 'factory corner 2',
    'fv_4' => 'administration building',
    'fv_5' => 'parking area',
    'fv_6' => 'multi-functional canteen',
    'fv_7' => 'the equipment waitting for deliver',
    'fv_8' => ' single beam in finished product area',
    'fv_9' => 'equipment going to deliver',
    'fv_10' => 'neat warehouse',
    'fv_11' => 'warehouse',
    'fv_12' => 'single beam workshop internal',
//生产设备
    'eq_1' => '100T hoist test bench',
    'eq_2' => 'Germany messer CNC flame plasma cutting machine',
    'eq_3' => 'U-shaped groove one-step molding roller line',
    'eq_4' => 'ND hoist assembly line',
    'eq_5' => 'electric hoist automatic painting and drying line',
    'eq_6' => 'automatic microcomputer controlled hoist test bench',
    'eq_7' => 'welding robot',
    'eq_8' => 'beam welding robot',
    'eq_9' => 'microcomputer controlled LMZQ—3000 four gas shielded gantry welding',
    'eq_10' => 'the side cover plate cold bending forming production line',
    'eq_11' => 'U-shaped groove cold rolling forming machine',
    'eq_12' => 'main girder jointless automatic molding line',
    'eq_13' => 'Multi-function CNC universal quenching machine tool and vacuum tube type high frequency induction heater',
    'eq_14' => 'CNC three-dimensional machining center',
    'eq_15' => 'Japan FANUC Oi mate CNC system "CY - K40 full-function CNC lathe"',
    'eq_16' => 'floor type boring and milling machine',
    'eq_17' => 'Double gantry welding gun',
    'eq_18' => 'Double-sided boring machine',
    'eq_19' => 'new hoist test bench',
    'eq_20' => 'Horizontal single drill bore compound combination machine tools',
    'eq_21' => 'High precision B50100 slotting machine',
    'eq_22' => 'Japanese Koike CNC flame cutting machine ',
    'eq_23' => 'Longitudinal shear unit',
    'eq_24' => 'P&C Lab',
    'eq_25' => 'shot blasting machine',
    'eq_26' => '',
    'eq_27' => '800t press machine',

//技术研发technology research and development
    'rd_1' => 'Technical Discussions',
    'rd_2' => 'overhead and gantry crane design office',

    //合作交流Cooperation and Exchange
    'ex_1' => 'Indian customers',
    'ex_2' => 'ABM President visit',
    'ex_3' => 'Demag visit 2',
    ...
    'cul_2' => 'Safety concept evening party',
    'cul_3' => 'personnel military training in spring',
    'cul_4' => 'Security games - blindfolded hurdles',
    'cul_5' => 'Emergency teams drill',
    'cul_6' => 'fire fighting drill',
    'cul_7' => 'Chess game ',
    'cul_8' => 'literary and artistic activity',
    'cul_9' => 'new and old employees basketball game',
    'cul_10' => 'culture wall',
    'cul_11' => 'Women’s day lectures',
    'cul_12' => 'vocational skills contest ',
    'cul_13' => 'Emergency rescue training',
